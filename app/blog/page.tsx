              ...
              <li key={post.slug}>
                ...
                >
                  ...
                  <div className="p-8">
                    ...
                    <h2 className="mt-3 font-heading text-headline font-semibold text-neutral-900 group-hover:text-primary transition-colors line-clamp-2 tracking-[0.01em]">
                      {post.title}
                    </h2>
                    <p className="mt-3 text-neutral-600 text-body-sm line-clamp-2">
                      {post.excerpt}
                    </p>
                    ...
                    <span className="mt-4 inline-flex items-center gap-2 text-primary font-medium text-sm transition-[gap] duration-200 group-hover:gap-2.5">
                      Read more
