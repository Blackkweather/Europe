...
import type { StudentStatus, MobilityType, ParticipantType, LearningAgreementStatus } from "@/lib/students-data";
...
export default function DashboardStudentsNewPage() {
  ...
  return (
    <>
      <PageHeader
        ...
        description="Register a new participant (student or staff)"
        breadcrumbs={[
