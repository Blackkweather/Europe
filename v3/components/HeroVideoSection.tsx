  ...
  return (
    ...
    >
      ...
      >
          ...
          <>
            ...
            {!videoReady && (
              <div className="absolute inset-0 bg-[var(--color-primary-dark)]">
                <Image src={images.hero} alt="" fill className="object-cover opacity-60" priority sizes="100vw" />
              </div>
            )}
          </>
        ) : (
        ...
        <div
          className="absolute inset-0 bg-gradient-to-b from-[var(--color-primary-dark)]/70 via-[var(--color-primary-dark)]/50 to-[var(--color-primary-dark)]"
          aria-hidden
        />
      </motion.div>
